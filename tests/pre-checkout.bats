...
@test "Pulls down VM when VM is missing" {
  stub anka \
    "list $VM : exit 1" \
    "registry pull $VM : echo 'pulled vm in anka'"
...
@test "Pulls down VM when VM is missing and has tag" {
  ...
  stub anka \
    "list $VM : exit 1" \
    "registry pull --tag my-tag $VM : echo 'pulled vm in anka'"
...
@test "Pulls down VM when VM is missing and has version" {
  ...
  stub anka \
    "list $VM : exit 1" \
    "registry pull --version 1 $VM : echo 'pulled vm in anka'"
...
@test "Pulls down VM when VM is always pulled (shrink)" {
  ...
  stub anka \
    "list $VM : exit 0" \
    "registry pull -s $VM : echo 'pulled vm in anka'"
...
registry_3'
  ...
  stub anka \
    ...
    "list $VM : exit 0" \
    "registry -r registry_2 pull $VM : echo 'pulled vm in anka'"
  ...
  stub anka \
    ...
    "list $VM : exit 0" \
    "registry -r registry_3 pull $VM : echo 'pulled vm in anka'"
